...
class MY_Model extends CI_Model {
    ...
    */
    ...
    public function find_by()
    {
        ...
        $row = $tris->db->get($this->table_name);
        $row = $this->_return_data($row);
    ...
    public function order_by($orderby, $direction = '') { $this->db->order_by($this->table_name.'.'.$orderby, $direction); return $this; }
    ...
    public function count_all_results() { $this->db->count_all_results($this->table_name); return $this; }
